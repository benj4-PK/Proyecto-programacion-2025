...
pygame.init()
fondo = pygame.image.load("../sprites/opciones.jpg")
fondo = pygame.transform.scale(fondo, (1200, 700))
fondo2 = pygame.image.load("../sprites/options.jpg")
fondo2 = pygame.transform.scale(fondo2, (1200, 700))
screen = pygame.display.set_mode((1200, 700))
pygame.display.set_caption("Menu Principal")
regresar = pygame.image.load("../sprites/back.png")
...
Boton_nulo = pygame.image.load("../sprites/midnight.jpg")
...
Boton_bajo = pygame.image.load("../sprites/casinoche.jpg")
...
Boton_Medio = pygame.image.load("../sprites/night.jpg")
...
Boton_Alto = pygame.image.load("../sprites/diaprueba0.jpg")
...
boton_español = pygame.image.load("../sprites/night.jpg")
...
boton_ingles = pygame.image.load("../sprites/night.jpg")
