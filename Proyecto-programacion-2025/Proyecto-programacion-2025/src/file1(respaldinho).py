...
walk_frames = cargar_frames(ruta("sprites/sprites_character/movs"))
run_frames = cargar_frames(ruta("sprites/sprites_character/run"))
dash_frames = cargar_frames(ruta("sprites/sprites_character/dash"))

idle_frame = pygame.transform.scale(pygame.image.load(ruta("sprites/sprites_character/idle_character.png")), (SPRITE_W, SPRITE_H))
jump_frame = pygame.transform.scale(pygame.image.load(ruta("sprites/sprites_character/jumping.png")), (SPRITE_W, SPRITE_H))
crouch_frame = pygame.transform.scale(pygame.image.load(ruta("sprites/sprites_character/Crouching_character.png")), (SPRITE_W, SPRITE_H))
